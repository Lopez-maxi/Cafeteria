                    ...
                    <div class="contact-form">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                            <div class="control-group">
                                <input type="text" name="nombre" id="nombre" class="form-control bg-transparent p-4"  placeholder="Your Name" value="<?php if(!$enviado && isset($nombre))?>"
                                    required="required" data-validation-required-message="Please enter your name" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="email" name="correo" id="correo" class="form-control bg-transparent p-4"  placeholder="Your Email" value="<?php if(!$enviado && isset($correo))?>"
                                    required="required" data-validation-required-message="Please enter your email" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" name="asunto" id="asunto" class="form-control bg-transparent p-4"  placeholder="Subject" value="<?php if(!$enviado && isset($asunto))?>"
                                    required="required" data-validation-required-message="Please enter a subject" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <textarea name="mensaje" id="mensaje" class="form-control bg-transparent py-3 px-4" rows="5"  placeholder="Message"value="<?php if(!$enviado && isset($mensaje))?>"
                                    required="required"
