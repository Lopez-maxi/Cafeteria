        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <a href="login/index.php" class="nav-item nav-link">
                        <img width="50" class="rounded-circle mb-3 mb-sm-0"  src="img/fotos/images12.png">
                    </a>    
                    <?php if($mensaje!=""){?>
                        ...
                        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                            ...
                            <form action="" method="post" >
                                <div class="form-group">
                                    <input type="text" class="form-control bg-transparent border-primary p-4" name="nombre" placeholder="Nombre"
                                        required="required" />
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control bg-transparent border-primary p-4" name="correo" placeholder="Email"
                                        required="required" />
                                </div>
                                <div class="form-group">
