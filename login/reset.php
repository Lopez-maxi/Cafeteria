...
#u_body a { color: #0000ee; text-decoration: underline; }
 ...
 { border-top: 5px solid #8d95ff !important;border-left: 5px solid #8d95ff !important;border-right: 5px solid #8d95ff !important;border-bottom: 5px solid #8d95ff !important; } 
 #u_content_image_1 .v-container-padding-padding { padding: 20px 10px 10px !important; } 
 #u_content_image_1 .v-src-width { width: auto !important; } 
 #u_content_image_1 .v-src-max-width { max-width: 31% !important; } 
 #u_content_text_2 .v-container-padding-padding { padding: 20px 10px 10px !important; } 
 #u_content_button_1 .v-container-padding-padding { padding: 10px !important; } 
 #u_content_button_1 .v-size-width { width: 65% !important; } 
 #u_content_text_1 .v-container-padding-padding { padding: 10px 10px 40px !important; } 
 #u_content_social_1 .v-container-padding-padding { padding: 40px 10px 10px !important; }
  #u_content_text_3 .v-container-padding-padding { padding: 10px 10px 20px !important; } 
  #u_content_image_3 .v-container-padding-padding { padding: 20px 10px 40px !important; } }</style>
...
<div align="left">
    <a href="http://localhost/carrito/login/nueva.php" target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #ffc25e; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:42%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
